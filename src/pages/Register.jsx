  ...
  return (
    <div className="auth-page">
      <div className="auth-left">
        <img src="https://images.unsplash.com/photo-1500595046743-cd271d694d30?w=900&q=85" alt="Indian agriculture" />
        <div className="auth-left-overlay">
          <img src="/logo.png" alt="Karshak Food Life" className="auth-logo" />
          <h2>Join Karshak<br />Food Life.</h2>
          <p>Create your account to manage enquiries and bulk orders.</p>
        </div>
      </div>
      ...
      <div className="auth-right">
        <div className="auth-card">
          <div className="auth-card-head">
            ...
            <p>Join Karshak Food Life today</p>
          </div>
          ...
          <form onSubmit={submit} className="auth-form">
            ...
            <div className="auth-field">
              ...
              <input name="confirm" type="password" placeholder="Re-enter password" value={form.confirm} onChange={handle} required />
            </div>
